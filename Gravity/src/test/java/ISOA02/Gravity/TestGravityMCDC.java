...
public class TestGravityMCDC {
    ...
    public void testSetDistanceA() throws DividedByZeroException, InvalidValueException {
    	g.setDistance(0);
    }
    
    @Test(expected = InvalidValueException.class)
    public void testSetDistanceB() throws DividedByZeroException, InvalidValueException {
     	g.setDistance(-2);
    }
